...
public class AnonGw {
    ...
    public static void main(String[] args){
        ...
        if(argc>=4) {
            ...
            try {
                InetAddress this_address = InetAddress.getByName("127.0.0.1");
                System.out.println(this_address.toString());
            } catch (UnknownHostException e) {
                System.out.println("Não conseguiu obter o endereço. Error: "+e.getMessage());
            }
/*
            try {
